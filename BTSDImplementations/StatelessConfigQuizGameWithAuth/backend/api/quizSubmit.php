...
function quizSubmitHandle():void
{
    ...
    $quizSubmitParams = new QuizSubmitParams($quizAttemptIdTemp,$answerOptionIdByUserTemp);
    ...
    $quizSubmitParams=new QuizSubmitParams($quizAttemptId,$answerOptionIdByUser);
